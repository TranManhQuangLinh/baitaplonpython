...
linkPlayerBullet = './data/bullet.png'  # Đường dẫn ảnh đạn player
linkEnemyBullet_default = './data/bullet 2.png'  # Đường dẫn ảnh đạn enemy
